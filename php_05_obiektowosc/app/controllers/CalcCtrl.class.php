...
class CalcCtrl {
	...
	getSmarty()->assign('page_header','Szablony Smarty zastosowane w kalkulatorze');

	getSmarty()->assign('form',$this->form);
	getSmarty()->assign('res',$this->result);
	getSmarty()->assign('miesieczne_oprocentowanie',$this->miesieczne_oprocentowanie);
	getSmarty()->assign('rata',$this->rata);
	getSmarty()->assign('calkowita_platnosc',$this->calkowita_platnosc);
